  ...
  <div className="max-w-6xl mx-auto px-6 relative z-10">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
      {[{ name: "นายแพทย์ ทวิช ศรีเกษม", 
        ...
        { name: "รศ.ดร. กิตติศักดิ์ แสนประสิทธ์", role: "คณะวิศวกรรมศาสตร์และเทคโนโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏเลย", img: Te1 },
        { name: "ผศ.ดร. คมยุทธ ไชยวงษ์", role: "คณะวิศวกรรมศาสตร์และเทคโนโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏเลย", img: Te2 },
      ].map((dev, i) => (
        <div
          key={i}
